...
public class AggregateController {
    ...
    public AggregateController() throws Exception {
        ...
        httpServer.createContext("/add-product", new NewProductHandler(productService, jwtUtil));
        ...
        httpServer.createContext("/remove-product", new RemoveProductHandler(productService, jwtUtil));
